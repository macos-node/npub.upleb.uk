      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-10 space-y-8">
        ...
        <div>
          <div className="flex items-center justify-between gap-3 mb-2">
            <AnimatedTitle accent="npub" rest="" from="#FF7849" to="#FFB347" suffixRgba="rgba(255,120,73,0.2)" />
            <NstartHand />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-muted-foreground">Nostr profile lookup — search relay.fizx.uk by npub or hex pubkey{' '}
